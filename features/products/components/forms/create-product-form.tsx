...
import { ProductImageField } from "../media/product-image-field"
...
export function CreateProductForm({
  ...
  const form = useForm({
    ...
    onSubmit: async ({ value }) => {
      ...
      try {
        const product = await onSubmit(value, selectedImageFile)
        onSuccess(product)
      } catch {
        setSubmitError("Không thể tạo sản phẩm. Vui lòng thử lại.")
      }
    },
  })
    ...
    >
        ...
        <div className="border-b border-border/70 px-5 py-4 sm:px-6">
          <div className="border-l-4 border-primary pl-4">
            ...
            <p className="mt-1 text-sm leading-6 text-muted-foreground">
              Nhập thông tin bắt buộc để tạo master sản phẩm. Revision đầu tiên
              sẽ được dùng làm gốc cho BOM - Routing sau khi lưu.
            </p>
          </div>
        </div>
      ) : null}
      ...
      >
        <ProductImageField
          ...
          canClear={!!selectedImageFile}
          onClear={() => handleImageFileChange(null)}
              ...
              return (
                <Field data-invalid={isInvalid}>
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      field.handleChange(
                        value as CreateProductFormInput["itemType"]
                      )
                    }
                  >
