...
import { DeleteClassButton } from "../shared/delete-class-button"
          ...
          <div className="grid w-full shrink-0 gap-2 sm:grid-cols-2 lg:flex lg:w-auto lg:grid-cols-none lg:flex-wrap lg:justify-end">
            ...
            {canManageClass ? (
              <>
                ...
                >
                  <Link
                    href={`/manage/classes/${classDetail.code}/edit` as Route}
                  >
                ...
                >
                  <Link
                    href={
                      `/manage/classes/${classDetail.code}/courses/add` as Route
                    }
                  >
