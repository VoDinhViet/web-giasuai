          ...
          <FieldGroup className="grid gap-4 lg:grid-cols-2">
            ...
            <form.Field name="instructorId">
              {(field) => {
                ...
                const selectedTeacherLabel = field.state.value
                  ? teacherOptions.find(
                      (teacherOption) =>
                        teacherOption.value === field.state.value
                    )?.label
                  : undefined
                      ...
                      <div className="min-w-0 flex-1 space-y-4">
                        ...
                        <div className="flex items-start gap-2 rounded border border-border/70 bg-card px-3 py-2">
                          ...
                          <div className="min-w-0">
                            ...
                            <p className="mt-0.5 text-sm leading-5 font-semibold break-words text-foreground">
                              {selectedTeacherLabel ?? "Chưa phân công"}
                            </p>
                          </div>
                        </div>
                      </div>
          ...
          <ClassPreview
            ...
            teacherLabel={
              values.instructorId
                ? teacherOptions.find(
                    (teacherOption) =>
                      teacherOption.value === values.instructorId
                  )?.label
                : undefined
            }
          />
...
function getClassFormValues(classDetail: ClassDetail): CreateClassInput {
  return {
