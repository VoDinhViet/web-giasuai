                ...
                onInvited={(enrollment) =>
                  setRequests((currentRequests) => [
                    ...
                    ...currentRequests.filter(
                      (request) => request.id !== enrollment.id
                    ),
                  ])
                }
              />
        ...
        <section className="rounded border border-border/80 bg-card p-5 shadow-xs">
          ...
          <div className="mt-5 grid gap-3">
            {requests.length > 0 ? (
              ...
              <div className="rounded border border-dashed border-border/80 bg-background p-6 text-center text-sm text-muted-foreground">
                Chưa có yêu cầu tham gia lớp.
              </div>
            )}
          </div>
        </section>
