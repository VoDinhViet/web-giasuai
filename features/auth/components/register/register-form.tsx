...
import { registerSchema } from "../../register/schemas/register.schema";
import { useTransition } from "react";
import { Alert, AlertTitle } from "@/components/ui/alert";
import { registerWithEmailPassword } from "../../register/actions/register-with-email-password";
    ...
    onSubmit: async ({ value }) => {
      startTransition(async () => {
        const result = await registerWithEmailPassword({
          ...value,
          role: value.role as UserRole.INSTRUCTOR | UserRole.LEARNER,
        });
              ...
              {(field) => (
                ...
                >
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value={UserRole.LEARNER}>
                        Tôi là học viên
                      </SelectItem>
